...
CGMZ.Versions["Title Command Window"] = "1.2.0";
...
//-----------------------------------------------------------------------------
const alias_CGMZ_TitleCommandWindow_drawItemBackground = Window_TitleCommand.prototype.drawItemBackground;
Window_TitleCommand.prototype.drawItemBackground = function(index) {
	...
	if(path) {
		...
		alias_CGMZ_TitleCommandWindow_drawItemBackground.call(this, index);
	}
};
//-----------------------------------------------------------------------------
// Draw command background image
//-----------------------------------------------------------------------------
Window_TitleCommand.prototype.CGMZ_bltCommandBackground = function(bitmap, rect, opts) {
	const sw = rect.width;
